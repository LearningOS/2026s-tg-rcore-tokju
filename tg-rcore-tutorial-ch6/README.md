...
**源码行号速查（当前 `src/main.rs`）：** `_start` 第 99-115 行（32 页内核栈）；`rust_main` 第 167-252 行；`kernel_space`（含 VirtIO MMIO）第 261-325 行；`impls` 第 341-791 行；`stub` 第 795 行起。入口为内联 `_start`，未使用 `boot0!`。
